...
class SlowTimeWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.btn_lyapunov = QPushButton('🔬  Lyapunov Analysis')
        ...
        self.btn_lyapunov.setStyleSheet(
            ...
            'QPushButton:disabled{color:#2a3050;}')
        self.btn_lyapunov.clicked.connect(self._on_lyapunov)
        ...
        rl.addWidget(self.btn_lyapunov,   3, 0, 1, 4)
        ...
        rl.addWidget(self.btn_modal,      4, 0, 1, 4)
        cl.addWidget(gr)
...
class _SlowTimeWindowMethods:
    ...
    def _on_modal(self):
        ...
        def _update_snapshots(step_i):
            ...
            A_fsr_k = r['A_modes_mu'][r['cur_k'], :, :]   # (NF, NS) μ domain
            # pump already at center index NF//2, no fftshift needed
            NF = r['NF']
            fsr = NF//2
            ...
            ax_mu.plot(mu_ax, 10*np.log10(np.abs(A_fsr_k[:, step_i])**2 + 1e-20),
                       color=K_COLOR, lw=1.2)
        ...
        def _update_supermode(k_idx):
            ...
            # pump is at index NF//2 after FFT — already centered, no fftshift needed
            power_th_k = np.abs(A_th_k)**2
            power_mu_k = np.abs(A_fsr_k)**2
            fsr = NF//2
    ...
    def _draw_all(self):
        ...
        self._plot_widgets = [
            self.btn_run, self.btn_stop, self.btn_save, self.btn_lyapunov, self.btn_modal,
